...
def get_pipeline():
    ...
    pipeline5 = [{"$match": {"created.user": {"$exists": 1}}},
                 ...
                 {"$sort": {"count": -1}},
                 {"$limit": 5}]
    #return [pipeline1, pipeline2, pipeline3, pipeline4, pipeline5] #used before database updated

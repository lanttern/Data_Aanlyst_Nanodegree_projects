...
```{r data exportation}
df.final1 <- df.final
colnames(df3) <- c("Founded year of startups", "Startup industry", "Number of startups in this industry", "Total number of founded startups", "Percentage of startups by industry")
...
write.csv(df3, file="data_other.csv", row.names=FALSE)

...
```{r data exportation}
colnames(df.final) <- c("Founded year of startups", "Startup industry", "Number of startups in this industry", "Total number of founded startups", "Percentage of this startup industry (number of startups in this industry normalized with total number of founded startups)")
